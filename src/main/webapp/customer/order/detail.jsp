                ...
                <tbody>
                    <%
                        ...
                        <tr>
                            ...
                            <td>Tk. <%= op.getProduct().getProductPrice() %></td>
                            <td><%= op.getBuyqty() %></td>
                            <td>Tk. <%= op.getBuyqty() * op.getProduct().getProductPrice() %></td>
                        </tr>
                        <%   
                        	sumAmu = sumAmu + op.getBuyqty() * op.getProduct().getProductPrice();
                        }
                    %>
                    <tr><td  colspan="4" class="text-center"><b>Total Amount</b></td><td>Tk. <%= sumAmu %></td></tr>
                </tbody>
            </table>
        </div>
    </div>
